...
public class Interaction {
	 ...
	 * Il instancie la matrice et gère la création du fichier de sortie.
	 */
	public Interaction() {
	...
	/**
	 * Demande les données nécessaires à l’utilisateur.
	 * Il le fait en plusieurs fois, d’abord pour la fonction objectif puis pour les contraintes, et enregistre tout dans la matrice.
	 */
	...
	/**
	 * Appelle la méthode calculerSolution de la classe Simplexe et envoie le résultat à ecrireDonnees() de la classe Impression.
	 */
